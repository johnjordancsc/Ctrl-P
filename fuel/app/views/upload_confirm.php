...
<head>
	...
	<style>
		...
		background-image:-khtml-gradient(linear, left top, left bottom, from(#297C24), to(#297C24));background-image:-moz-linear-gradient(top, #297C24, #297C24);background-image:-ms-linear-gradient(top, #297C24, #297C24);
		background-image:-webkit-gradient(linear, left top, left bottom, color-stop(0%, #297C24), color-stop(100%, #297C24));
		background-image:-webkit-linear-gradient(top, #297C24, #297C24);
		background-image:-o-linear-gradient(top, #297C24, #297C24);
		background-image:linear-gradient(top, #297C24, #297C24);
		filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#297C24', endColorstr='#297C24', GradientType=0);
		text-shadow:0 -1px 0 rgba(0, 0, 0, 0.25);
		border-color:#297C24 #297C24 #003f81;
...
<body>
	<header>
		<div class="container">
			...
			if(!isset($type))
			{
?><div class = "alert alert-danger"><strong>Error: </strong><?php echo $error; ?></div><br>
<a href="/upload/">Try To upload a different file.</a>
...
<?php 
			...
			{
?><div class="container"><h1>Upload Confirmation</h1>
		<div class="jumbotron" style=" padding-top:20px;">

<div class="jumbotron" style="background-color: #F9F9F9; padding-top:15px;">
You have uploaded the File <span style="color:green;"><?= $file ?></span><br>
File Type: <span style="color:green;"><?= $type ?></span><br>
Page(s): <?

/*
if($pages > $balance)	
{
	echo "<span style='color:red;' >".$pages."</span><br>";
	echo "<div class = \"alert alert-danger\"><strong>Error: </strong>Insufficient Balance to Print this file!</div><br>";
	
	
	?>
	
	<input type="button" class="btn btn-lg btn-primary" value = "&lt; Back" onclick="window.location='/upload/';">
	
	<input type="button" class="btn btn-lg btn-primary pull-right" value = "Payment" disabled="disabled">
...
{
*/
	echo "<span  >".$pages."</span> <br><br>";
	?>
	
<div>
<form action="/format/" method="post">
Do you want to proceed based on this information?<br><br>
<input type="button" class="btn btn-lg btn-danger" value = "&lt; Cancel" onclick="window.location='/upload/';">
<input type="hidden" name="internal_file" value = "<?php echo $internal; ?>" >
<input type="hidden" name="uploaded_file" value = "<?php echo $uploaded; ?>" >
<input type="hidden" name="pages" value = "<?php echo $pages; ?>" >
<input type="submit" class="btn btn-lg btn-primary pull-right" value = "Proceed &gt;">
</form>
</div>
</div>
<?php 
