...
if(Session::get ( 'access_token' ) == false )
{
	...
	header("Location: ".config::get('base_url')."account/notoken/");
}
...
<span class="alert alert-danger"><strong>Warning!</strong> Your balance is currently 0!</span><br><br>
</div> 
<?php 
...
?>
<div style="text-align:center">
<span class="alert alert-warning"><strong>Warning!</strong> Your balance is Low, Please make sure to add Credit to your balance.</span><br><br>
</div> 
<?php 
  ...
  <input type="file" style="width: 35%;" id ="file" name="file" class="form-control" required="required">
  
   <input type="submit" value="Upload" class="btn btn-large btn-success pull-right">
