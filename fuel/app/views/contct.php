...
<head>
    <meta charset="utf-8">
    <title>HEC | Contact US</title>
    <?php echo Asset::js('jquery-1.11.1.js'); ?>
    <?php echo Asset::css('bootstrap.css'); ?>
    <?php echo Asset::css('style.css'); ?>
    <?php echo Asset::css('bxslider/jquery.bxslider.css'); ?>
    <?php echo Asset::js('jquery.bxslider.min.js'); ?>
    <?php echo Asset::css('isotope/style.css'); ?>
    <?php echo Asset::js('jquery.isotope.min.js'); ?>
    <?php echo Asset::js('selectnav.min.js'); ?>
    <?php echo Asset::js('jquery.tipsy.js'); ?>
    <?php echo Asset::css('tipsy/tipsy.css'); ?>
    <?php echo Asset::css('ytplayer/YTPlayer.css'); ?>
    <?php echo Asset::js('jquery.mb.YTPlayer.js'); ?>
    <?php echo Asset::js('jquery.appear.min.js'); ?>
    <style>
        #logo{
            display: block;
            background-image: ;
        ...
        .btn.btn-primary{
            ...
            background-image:-khtml-gradient(linear, left top, left bottom, from(#fd6ef7), to(#883ced));background-image:-moz-linear-gradient(top, #fd6ef7, #883ced);background-image:-ms-linear-gradient(top, #fd6ef7, #883ced);
...
<div class="header solid">
    ...
    <ul id="menu" class="main_menu">
        <li><a href="<?php echo config::get('base_url').'layout'; ?>" >Home</a></li>
        <li><a href="<?php echo config::get('base_url').'contact'; ?>" >About</a></li>
...
<section id="contact" class="sect-2">
    <div class="container">
        ...
        <form method="post" action="php/send_message.php" class="contact-form">
            <div class="one-half animated fadeInDown" data-animate="fadeInDown" style="visibility: visible;">
					<span>
            ...
            <div class="one-half last animated fadeInDown" data-animate="fadeInDown" data-animate-delay="1000" style="visibility: visible;">
					<span>
						<textarea name="message" id="message" placeholder="message"></textarea>
					</span>
            </div><!-- End .one-half -->
            <button id="submit" type="submit" class="contact-button animated fadeInDown" data-animate="fadeInDown" data-animate-delay="1000" style="visibility: visible;">Send Message</button>
        </form>
