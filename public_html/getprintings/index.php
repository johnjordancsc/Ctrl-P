...
$q = "select * from file_queue join login_users on login_users.email = file_queue.user_name where file_queue.printed = '1' order by file_queue.entry_id ";
$data = mysql_query($q);
...
header('Content-Disposition: attachment; filename="printings.csv"');
...
echo "Date,".
		...
		"Printer Location,".
		"Document Name,".
		"Page Balance Before Printing,".
		"Page Balance After Printing\r\n";
